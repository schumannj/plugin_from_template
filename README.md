# nomad-catalysis_test

a schema package plugin for catalysis
...
```
pip install dist/nomad-catalysis_test-0.1.0
```
...
### License
Distributed under the terms of the `MIT`_ license, "nomad-catalysis_test" is free and open source software
